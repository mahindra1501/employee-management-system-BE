import {
  ConnectionIndicator,
  ConnectionState
} from "./chunk-YZICJZRC.js";
import "./chunk-YCMVRXTB.js";
...
var Flow = class {
  ...
  async flowInit(serverSideRouting = false) {
    if (!this.isFlowClientLoaded()) {
      ...
      const bootstrapMod = await import("./FlowBootstrap-WSN5OIAH.js");
      await bootstrapMod.init(this.response);
      if (typeof this.config.imports === "function") {
        this.injectAppIdScript(appId);
        await this.config.imports();
      }
      const clientMod = await import("./FlowClient-ZWQYMQIF.js");
