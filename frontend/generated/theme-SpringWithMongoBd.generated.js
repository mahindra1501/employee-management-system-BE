...
import stylesCss from 'themes/SpringWithMongoBd/styles.css?inline';
...
export const applyTheme = (target) => {
  ...
  if (!document['_vaadintheme_SpringWithMongoBd_componentCss']) {
    
    document['_vaadintheme_SpringWithMongoBd_componentCss'] = true;
  }
